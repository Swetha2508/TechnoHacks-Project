...
$nameErr = $emailErr = $phoneErr = $genderErr = $courseErr = $collegeErr = $technicalErr ="";

$name = $email = $phone = $gender = $course = $college = $technical ="";
...
$connec = mysqli_connect("localhost","root","","projTWO");
  if(isset($_POST['submit']))
  {
    ...
    $query = "INSERT into reg(name,email,phone,gender,college,course,technical) values('$name1','$email1','$phone1','$gender1','$college1','$course1','$technical1')";
